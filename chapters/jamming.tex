...
\begin{equation}
p \sim \dot{\gamma}^2 \Rightarrow \frac{\partial}{\partial\dot{\gamma}} B_p = 0,~ B_p \equiv p/\dot{\gamma}^2
\end{equation}
to Newtonian rheology
\begin{equation}
p \sim \dot{\gamma} \Rightarrow \frac{\partial}{\partial\dot{\gamma}} \eta_p = 0,~ \eta_p \equiv p/\dot{\gamma}
\end{equation}
